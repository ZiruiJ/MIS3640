...
# time = Time()   #create object time, 3 attributes
# time.hour = 3
# time.minute = 12
# time.second = 30
...
def print_time(t):#a parameter, no connection with time
...
def int_to_time(seconds):
    ...
    """
    time = Time()
    minutes, time.second = divmod(seconds, 60)  #divide seconds and minute
